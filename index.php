...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['task'])) {
    $task = $_POST['task'];
    $due_date = $_POST['due_date']; // Ambil tanggal tenggat
    $status = 0;  // Set status menjadi 'Belum Selesai'

    // Query untuk menambahkan tugas baru dengan status
...
<body>
    <div class="container">
        ...
        <form method="POST">
            ...
            <button type="submit"> <i class="bi bi-plus-circle"></i> Tambah Tugas</button>
